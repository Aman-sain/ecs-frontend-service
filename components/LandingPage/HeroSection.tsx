...
export function HeroSection({ onGetStarted, onLearnMore }: HeroSectionProps) {
  const words = "Enterprise EMS".split(" ");
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
        ...
        >
          ...
          <motion.p
            ...
            className="text-lg sm:text-xl md:text-2xl text-neutral-600 dark:text-neutral-400 mb-12 max-w-2xl mx-auto"
          >
            Modern, scalable employee management system built for the future
          </motion.p>
        ...
        >
          ...
          >
            <ArrowDown className="h-8 w-8 text-neutral-400" />
          </motion.div>
        </motion.div>
      </div>
    </section>
